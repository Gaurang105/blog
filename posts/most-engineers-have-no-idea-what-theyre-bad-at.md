---
title: "Most Engineers Have No Idea What They're Bad At. Here's How to Find Out."
date: "2026-02-13"
excerpt: "Stop learning everything and start fixing what's actually holding you back. A practical approach to quantifying your engineering skills using PR review comments and turning them into a targeted growth plan."
tags: ["career growth", "engineering", "self-improvement", "code review", "productivity"]
---
...
1. **Pull your PR review comments** from the last 3-6 months.
2. **Feed them to an AI** (Claude, ChatGPT, whatever) and ask it to find patterns, common feedback, strengths, and weaknesses.
3. **Be honest with the results.** Don't get defensive. These are people trying to make your code better.
4. **Build a specific action plan.** Tie every action item to a real pattern from your reviews. Make it concrete enough that you can actually check it off.
5. **Revisit in 3 months.** Pull the comments again. See if the same patterns show up. If they don't, you've actually grown. Measurably.
